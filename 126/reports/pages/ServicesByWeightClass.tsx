/**
 * Services by Weight Class Report
 * Service distribution by dog size
 */
...
export function ServicesByWeightClass() {
  ...
  if (isLoading) {
    return (
      <ReportShell title="Services by Weight Class" description="Service by size" defaultTimeBasis="service">
  ...
  return (
    <>
      <ReportShell title="Services by Weight Class" description="Service distribution by dog size" defaultTimeBasis="service" onShowDefinitions={() => setShowDefinitions(true)}>
        <KPIDeck metrics={kpis} />
        <DataTable
          title="Service/Weight Class Combinations"
          data={tableData}
          columns={[
